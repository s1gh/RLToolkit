...
(function () {
  ...
  events.catalog = [
    ...
    // need to look anything up themselves.
    {
      ...
      shape: 'stat-enriched',
      livePhases: ['live', 'replay'],
      desc: 'StatfeedEvent with MainTarget/SecondaryTarget pre-resolved. NOTE: fires for every Statfeed variant including those with dedicated promoted events. Subscribing to both this and a promoted event sees the same Statfeed twice.',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'statfeed:catchall',
    },
    {
      name: '_BallHit',
      category: 'play',
    ...
    },
    {
      ...
      shape: 'goal-enriched',
      livePhases: ['live', 'replay'],
      desc: 'GoalScored with players resolved + scoringTeam/concedingTeam/isOwnGoal flags + same-frame modifiers (aerial/long/turtle/hatTrick/etc.). The isOwnGoal flag is heuristic and synchronous; for verified own-goal detection use _OwnGoal.',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'scoring',
    },
    {
      name: '_OwnGoal',
      category: 'scoring',
      shape: 'owngoal',
      livePhases: ['live', 'replay'],
      desc: 'Score-delta verified own goal: emitted when a team scores +1 and the most recent ball touch was by the opposing team. Phase-gated to live/replay. Higher confidence than _GoalScored.isOwnGoal.',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'scoring',
    },
    // Statfeed-derived synthetics. Backend resolves Main/SecondaryTarget
    // against the live roster + adds correlation fields where useful.
    {
      name: '_PlayerDemolished',
      category: 'stat',
      shape: 'demolish',
      livePhases: ['live', 'replay'],
      desc: 'Demolish with attacker/victim resolved + isSelfDemo / isTeamDemo flags + attackerSpeed / attackerWasSupersonic from the most recent UpdateState (SPECTATOR-only).',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'statfeed:promoted',
    },
    {
      name: '_FlipReset',
      category: 'stat',
      shape: 'stat-simple',
      livePhases: ['live', 'replay'],
      desc: 'FlipReset with MainTarget resolved + flipResetsThisMatch counter.',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'statfeed:promoted',
    },
    {
      ...
      shape: 'stat-simple',
      livePhases: ['live', 'replay'],
      desc: 'HatTrick with MainTarget resolved + goalsThisMatch counter.',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'statfeed:promoted',
    },
    {
      ...
      shape: 'save',
      livePhases: ['live', 'replay'],
      desc: 'Save with MainTarget resolved + correlatedShot (most recent opposing-team Shot).',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'statfeed:promoted',
    },
    {
      ...
      shape: 'save',
      livePhases: ['live', 'replay'],
      desc: 'Same as _Save but for the EpicSave variant. Mutually exclusive with _Save on the wire.',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'statfeed:promoted',
    },
    {
      ...
      shape: 'shot',
      livePhases: ['live', 'replay'],
      desc: 'Shot with MainTarget resolved + correlatedTouch (same-frame BallHit with pre/post hit speeds).',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'statfeed:promoted',
    },
    {
      ...
      shape: 'assist',
      livePhases: ['live', 'replay'],
      desc: 'Assist with MainTarget resolved + correlatedGoal (most recent _GoalScored).',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'statfeed:promoted',
    },
    {
      ...
      shape: 'stat-touch',
      livePhases: ['live', 'replay'],
      desc: 'Center with MainTarget resolved + correlatedTouch (with pre/post hit speeds).',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'statfeed:promoted',
    },
    {
      ...
      shape: 'stat-touch',
      livePhases: ['live', 'replay'],
      desc: 'Clear with MainTarget resolved + correlatedTouch (with pre/post hit speeds).',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'statfeed:promoted',
    },
    {
      ...
      shape: 'stat-touch',
      livePhases: ['live', 'replay'],
      desc: 'BicycleHit with MainTarget resolved + correlatedTouch (with pre/post hit speeds). For bicycle-hits that scored, see _GoalScored.modifiers.isBicycleGoal.',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'statfeed:promoted',
    },
    ...
    // UpdateState entirely.
    {
      ...
      shape: 'player-event',
      livePhases: '*',
      desc: 'Roster diff: player appeared this tick. Includes current lifecycle phase so consumers can distinguish lobby joins from mid-match joins.',
      stability: 'provisional',
      since: '1.1',
    },
    {
      ...
      shape: 'player-event',
      livePhases: '*',
      desc: 'Roster diff: player disappeared this tick. Includes current lifecycle phase so consumers can distinguish lobby leaves from mid-match rage-quits.',
      stability: 'provisional',
      since: '1.1',
    },
    {
    ...
    },
    {
      ...
      shape: 'possession',
      livePhases: ['live'],
      desc: 'Game.Ball.TeamNum changed. before/after nullable — 255 → null. Includes triggeredBy (player + pre/post hit speeds) from the most recent BallHit.',
      stability: 'provisional',
      since: '1.1',
    },
    {
      ...
      livePhases: ['live', 'replay'],
      desc: 'A team Score moved. Catch-all for score changes — fires alongside _GoalScored and _OwnGoal. Subscribe to one of the three depending on detail needed.',
      stability: 'provisional',
      since: '1.1',
      subscriptionGroup: 'scoring',
    },
    ...
    },
    {
      ...
      livePhases: ['live'],
      desc: 'Rising edge of Game.bOvertime. Once per match. Includes tiedAt (the tied score going into OT).',
      stability: 'provisional',
      since: '1.1',
    },
    {
      ...
      shape: 'demo-chain',
      livePhases: ['live', 'replay'],
      desc: 'Same attacker registered ≥2 demos within a rolling 5s window. Self-demos and team-demos excluded. Re-fires with updated count + victims[] for each subsequent demo inside the window.',
      stability: 'provisional',
      since: '1.2',
    },
    {
      name: '_FastestShotOfMatch',
      category: 'scoring',
      shape: 'fastest-shot',
      livePhases: ['live', 'replay'],
      desc: 'Per-match max ball speed was surpassed. Sources: BallHit.postHitSpeed and GoalScored.goalSpeed. Re-fires only when the previous max is beaten.',
      stability: 'provisional',
      since: '1.2',
    },
    {
      name: '_KickoffConverted',
      category: 'scoring',
      shape: 'kickoff-converted',
      livePhases: ['live'],
      desc: 'First _Shot or _GoalScored within ~10s of RoundStarted, attributed to the team responsible. Once-per-round.',
      stability: 'provisional',
      since: '1.2',
    },
    ...
    },
    {
      ...
      livePhases: '*',
      desc: 'On the bReplay rising edge (start of a goal replay), the full _GoalScored payload (scorer, assister, ballLastTouch, goalSpeed, goalTime, impactLocation, isOwnGoal, modifiers) so plugins know which goal the replay is for. Edge-detected on UpdateState because recent RL builds skip the discrete GoalReplayStart event.',
      stability: 'provisional',
      since: '1.1',
    },
    {
    ...
    },
    {
      ...
      shape: 'match-mvp',
      livePhases: '*',
      desc: 'Fires whenever the MVP Statfeed arrives, independent of _MatchSummary timing. Includes winnerTeamNum, arrivedAfterSummary (true if _MatchSummary already published), and secondsAfterMatchEnd. RL can ship MVP several seconds after PodiumStart, past the summary settle window — this event guarantees plugins still see it.',
      stability: 'provisional',
      since: '1.1',
    },
