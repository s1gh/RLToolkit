...
(function () {
  ...
  events.catalog = [
    ...
    // against the live roster + adds correlation fields where useful.
    {
      ...
      shape: 'demolish',
      livePhases: ['live', 'replay'],
      desc: 'Demolish with attacker/victim resolved + isSelfDemo / isTeamDemo flags.',
      stability: 'provisional',
      since: '1.1',
    },
    {
      ...
      shape: 'stat-simple',
      livePhases: ['live', 'replay'],
      desc: 'FlipReset with MainTarget resolved.',
      stability: 'provisional',
      since: '1.1',
    },
    {
    ...
    },
    {
      ...
      shape: 'shot',
      livePhases: ['live', 'replay'],
      desc: 'Shot with MainTarget resolved + correlatedTouch (same-frame BallHit).',
      stability: 'provisional',
      since: '1.1',
    },
    {
    ...
    },
    {
      ...
      shape: 'stat-touch',
      livePhases: ['live', 'replay'],
      desc: 'Center with MainTarget resolved + correlatedTouch.',
      stability: 'provisional',
      since: '1.1',
    },
    {
      ...
      shape: 'stat-touch',
      livePhases: ['live', 'replay'],
      desc: 'Clear with MainTarget resolved + correlatedTouch.',
      stability: 'provisional',
      since: '1.1',
    },
    {
      ...
      shape: 'stat-touch',
      livePhases: ['live', 'replay'],
      desc: 'BicycleHit with MainTarget resolved + correlatedTouch.',
      stability: 'provisional',
      since: '1.1',
    },
    ...
    },
    {
      ...
      livePhases: '*',
      desc: 'On the bReplay rising edge (start of a goal replay), the most recent _GoalScored payload (scorer, scoringTeam) so plugins know which goal the replay is for. Edge-detected on UpdateState because recent RL builds skip the discrete GoalReplayStart event.',
      stability: 'provisional',
      since: '1.1',
    },
    {
    ...
    },
    {
      ...
      shape: 'match-mvp',
      livePhases: '*',
      desc: 'Fires whenever the MVP Statfeed arrives, independent of _MatchSummary timing. RL can ship MVP several seconds after PodiumStart, past the summary settle window — this event guarantees plugins still see it.',
      stability: 'provisional',
      since: '1.1',
    },
